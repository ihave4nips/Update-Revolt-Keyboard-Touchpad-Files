...
*/
// This software interfaces the Teensy with a PS/2 touchpad from a laptop.
...
// In the Arduino IDE, select Tools and the Teensy you are using. Also under Tools, select Keyboard+Mouse+Joystick
//
// Revision History
// Rev 1.0 - Dec 16, 2023 - Original Release (converted from the 3.2 code)
//
...
#define ERROR_LED 13  // change this to 6 for the Teensy 2.0++
//
...
void setup()
{
  ...
  pinMode(ERROR_LED, OUTPUT); // define teensy I/O driving LED as an output
}
